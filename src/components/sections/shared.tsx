...
const FILE_HINT: Partial<Record<SectionKey, string>> = {
  ...
  salesByECP:          "Upload \"Salesman Sales and Collection Listing By Account <Mon><yy>.xlsx\" — preferred. Falls back to outlet Excel + ECP List.xlsx if salesman is absent.",
  salesByRegion:       "Upload \"Sales Analysis By Region <Mon><yy>.xlsx\" — the state/country grouped report. Falls back to outlet Excel + ECP List.xlsx.",
